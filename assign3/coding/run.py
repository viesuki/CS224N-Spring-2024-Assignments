    ...
    while True:
        ...
        for src_sents, tgt_sents in batch_iter(train_data, batch_size=train_batch_size, shuffle=True):
            ...
            if train_iter % log_every == 0:
                ...
                print('epoch %d/%d , iter %d, avg. loss %.2f, avg. ppl %.2f ' \
                      'cum. examples %d, speed %.2f words/sec, time elapsed %.2f sec' % (epoch, int(args['--max-epoch']), train_iter,
            ...
            if train_iter % valid_niter == 0:
                ...
                print('epoch %d/%d, iter %d, cum. loss %.2f, cum. ppl %.2f cum. examples %d' % (epoch, int(args['--max-epoch']),train_iter,
